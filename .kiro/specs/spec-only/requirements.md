...
3. THE Terraform_Generator SHALL create Private_Subnets in exactly 3 Availability_Zones
4. THE Terraform_Generator SHALL create an Internet Gateway attached to the VPC
5. THE Terraform_Generator SHALL create route tables that direct public subnet traffic to the Internet Gateway
6. WHEN calculating subnet CIDR blocks, THE Terraform_Generator SHALL ensure non-overlapping address ranges within the VPC
